...
public interface AllotmentRepository extends JpaRepository<Allotment, Long> {
    ...
    Optional<Allotment> findFirstByFlatAndStatus(Flat flat, AllotmentStatus status);

    Optional<Allotment> findFirstByFlatIdAndStatus(Long flatId, AllotmentStatus status);

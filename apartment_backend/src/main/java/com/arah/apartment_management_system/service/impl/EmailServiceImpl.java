...
public class EmailServiceImpl implements EmailService {
    ...
    @Value("${brevo.sender.email:lachochow1991@gmail.com}")
    ...
    private void sendBrevoEmail(String toEmail, String subject, String htmlContent) {
        ...
        sender.put("name", "BR Meadowlands");
        ...
        try {
            ...
            System.out.println("Email sent successfully via Brevo: " + response.getStatusCode());
        } catch (Exception e) {
    ...
    public void sendResetPasswordEmail(String toEmail, String token) {
        ...
        sendBrevoEmail(toEmail, "Reset Your Password - BR Meadowlands", htmlContent);
    }
    ...
    public void sendPaymentReminder(String toEmail, String residentName, String flatNumber, double amount, String dueDate) {
        ...
        sendBrevoEmail(toEmail, "Maintenance Payment Reminder - BR Meadowlands", htmlContent);
    }
}
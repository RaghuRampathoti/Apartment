...
export default function ResidentDashboard() {
  ...
  const handleRaiseServiceRequest = async (e) => {
    e.preventDefault();
    if (!serviceRequestFormData.preferredSlot) {
      showToast("Please select a preferred timing / slot", "error");
      return;
    }
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-primary/10 selection:text-primary no-scrollbar">
                  ...
                  <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl max-h-[90vh] flex flex-col overflow-hidden">
                    ...
                    <div className="flex items-center justify-between px-8 pt-8 pb-5 border-b border-slate-100">
                      ...
                      <button
                        onClick={() => {
                          setTenantFormData({
                            name: "", contactNumber: "", email: "", aadharNumber: "",
                            maritalStatus: "Bachelor", moveInDate: "", username: "",
                            password: "", isEmployee: false, monthlyRent: ""
                          });
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={e => {
                            ...
                            setTenantFormData(p => ({ ...p, name: val }));
                          }}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={e => {
                            ...
                            setTenantFormData(p => ({ ...p, contactNumber: val }));
                          }}
                          className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500/40 focus:border-teal-500 transition"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={e => {
                            ...
                            setTenantFormData(p => ({ ...p, aadharNumber: val }));
                          }}
                          className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500/40 focus:border-teal-500 transition"
                        />
                      </div>
                        ...
                        <div className="flex flex-col gap-3">
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <input
                                type={showTenantPassword ? "text" : "password"} required
                                placeholder="Set a strong password"
                                value={tenantFormData.password}
                                onChange={e => setTenantFormData(p => ({ ...p, password: e.target.value }))}
                                className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500/40 focus:border-teal-500 transition pr-10"
                              />
                              <button
                                type="button"
                ...
                <div className="profile-card">
                  ...
                  <div className="profile-details">
                    <div className="detail-row">
                      ...
                      {isEditingProfile ? (
                        <input
                          ...
                          onChange={(e) => setProfileFormData({ ...profileFormData, username: e.target.value.replace(/[^a-zA-Z\s]/g, '') })}
                        />
                      ) : (
                    ...
                    <div className="detail-row">
                      ...
                      {isEditingProfile ? (
                        <input
                          ...
                          onChange={(e) => setProfileFormData({ ...profileFormData, contactNumber: e.target.value.replace(/\D/g, '').slice(0, 10) })}
                        />
                      ) : (
                    ...
                    <div className="detail-row">
                      ...
                      {isEditingProfile ? (
                        <div className="file-input-wrapper" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                          <input
                            type="file"
                            accept=".pdf,image/*"
                          ...
                          />
                          {(aadharFile || profileFormData.aadharUrl) && (
                            <button
                              type="button"
                              title="Preview Aadhar Card"
                              onClick={() => {
                                if (aadharFile) {
                                  setViewImage(URL.createObjectURL(aadharFile));
                                  setViewFileType(aadharFile.type);
                                } else {
                                  setViewImage(getReceiptUrl(profileFormData.aadharUrl));
                                  setViewFileType(profileFormData.aadharUrl?.toLowerCase().endsWith('.pdf') ? 'application/pdf' : 'image/jpeg');
                                }
                              }}
                              style={{ background: 'var(--primary)', color: '#fff', border: 'none', borderRadius: '8px', padding: '6px 10px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px', fontSize: '12px', fontWeight: 700, whiteSpace: 'nowrap' }}
                            >
                              👁 Preview
                            </button>
                          )}
                        ...
                        user?.aadharUrl ? (
                          <button
                            type="button"
                            className="doc-link"
                            onClick={() => { setViewImage(getReceiptUrl(user.aadharUrl)); setViewFileType(user.aadharUrl?.toLowerCase().endsWith('.pdf') ? 'application/pdf' : 'image/jpeg'); }}
                      ...
                      {isEditingProfile ? (
                        <div className="file-input-wrapper" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                          <input
                            ...
                            className="file-input"
                          />
                          {(panFile || profileFormData.panCardUrl) && (
                            <button
                              type="button"
                              title="Preview PAN Card"
                              onClick={() => {
                                if (panFile) {
                                  setViewImage(URL.createObjectURL(panFile));
                                  setViewFileType(panFile.type);
                                } else {
                                  setViewImage(getReceiptUrl(profileFormData.panCardUrl));
                                  setViewFileType(profileFormData.panCardUrl?.toLowerCase().endsWith('.pdf') ? 'application/pdf' : 'image/jpeg');
                                }
                              }}
                              style={{ background: 'var(--primary)', color: '#fff', border: 'none', borderRadius: '8px', padding: '6px 10px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px', fontSize: '12px', fontWeight: 700, whiteSpace: 'nowrap' }}
                            >
                        ...
                        user?.panCardUrl ? (
                          <button
                            type="button"
                            className="doc-link"
                            onClick={() => { setViewImage(getReceiptUrl(user.panCardUrl)); setViewFileType(user.panCardUrl?.toLowerCase().endsWith('.pdf') ? 'application/pdf' : 'image/jpeg'); }}
                            style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, color: 'var(--primary)', fontWeight: 600 }}
                          >
                            💳 View PAN Card
                          </button>
            ...
            <div className="fade-in-up">
              ...
              <div className="overview-section no-padding-bottom">
                <div className="section-header-flex">
                  <h3>⚡ Quick Actions</h3>
                  <span className="customize-link"></span>
                </div>
                <div className="quick-actions-mobile-grid">
                  ...
                  <div className="qa-item" onClick={() => setShowMoreQuickActions(v => !v)}>
                    <div className="qa-icon-container qa-plus shadow-sm" style={showMoreQuickActions ? { background: 'var(--primary)', color: '#fff' } : {}}>
                      {showMoreQuickActions
                        ? <I d={<><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></>} />
                        : <PlusIconSVG />}
                    </div>
                    <span className="qa-label">{showMoreQuickActions ? 'Show Less' : 'View More'}</span>
                  </div>
                </div>

                {/* Expanded Quick Actions */}
                {showMoreQuickActions && (
                  <div className="quick-actions-mobile-grid" style={{ marginTop: '12px', paddingTop: '12px', borderTop: '1px dashed #e2e8f0', animation: 'fadeInUp 0.25s ease' }}>
                    <div className="qa-item" onClick={() => setActiveView("polls")}>
                      <div className="qa-icon-container shadow-sm"><VoteIconSVG /></div>
                      <span className="qa-label">Polls</span>
                    </div>
                    <div className="qa-item" onClick={() => setActiveView("facilities")}>
                      <div className="qa-icon-container shadow-sm"><PoolIconSVG /></div>
                      <span className="qa-label">Facilities</span>
                    </div>
                    <div className="qa-item" onClick={() => setActiveView("parking")}>
                      <div className="qa-icon-container shadow-sm"><CarIconSVG /></div>
                      <span className="qa-label">Parking</span>
                    </div>
                    <div className="qa-item" onClick={() => setActiveView("visitors")}>
                      <div className="qa-icon-container shadow-sm"><UsersIconSVG /></div>
                      <span className="qa-label">Visitors</span>
                    </div>
                    <div className="qa-item" onClick={() => setActiveView("serviceRequests")}>
                      <div className="qa-icon-container shadow-sm"><WrenchIconSVG /></div>
                      <span className="qa-label">Service Req.</span>
                    </div>
                    <div className="qa-item" onClick={() => setActiveView("myTenant")}>
                      <div className="qa-icon-container shadow-sm"><BriefIconSVG /></div>
                      <span className="qa-label">My Tenant</span>
                    </div>
                    <div className="qa-item" onClick={() => setActiveView("societyRules")}>
                      <div className="qa-icon-container shadow-sm"><BookIconSVG /></div>
                      <span className="qa-label">Rules</span>
                    </div>
                    <div className="qa-item" onClick={() => setActiveView("faq")}>
                      <div className="qa-icon-container shadow-sm"><HelpCircleIconSVG /></div>
                      <span className="qa-label">FAQ</span>
                    </div>
                    <div className="qa-item" onClick={() => setActiveView("feedback")}>
                      <div className="qa-icon-container shadow-sm"><MessageSquareIconSVG /></div>
                      <span className="qa-label">Feedback</span>
                    </div>
                  </div>
                )}
              </div>
          ...
          {activeView === "serviceRequests" && (
            <div className="fade-in-up">
              <div className="page-header page-header-container">
                ...
                <button className="btn" style={{ background: '#00897B', color: 'white' }} onClick={() => {
                    ...
                    <form onSubmit={handleRaiseServiceRequest}>
                      ...
                      <div className="inline-form-row">
                        <div className="inline-form-group wide-group">
                          <label>Preferred Timing / Slot <span className="required-star">*</span></label>
                          <input
                            type="datetime-local"
                      ...
                      <div className="inline-form-actions">
                        <button type="button" className="inline-btn inline-btn-cancel" onClick={() => {
                          setServiceRequestFormData({ serviceType: "PLUMBER", description: "", preferredSlot: "" });
                          setShowServiceRequestModal(false);
                        }}>Cancel</button>
      ...
      {viewImage && (
        <div className="modal-overlay" onClick={() => { setViewImage(null); setViewFileType(null); }} style={{ zIndex: 2000 }}>
          <div className="modal-content" onClick={e => e.stopPropagation()} style={{ maxWidth: '90vw', maxHeight: '92vh', padding: '10px', position: 'relative' }}>
            <button
              onClick={() => { setViewImage(null); setViewFileType(null); }}
              style={{ position: 'absolute', top: '-15px', right: '-15px', borderRadius: '50%', width: '30px', height: '30px', border: 'none', background: '#e74c3c', color: 'white', cursor: 'pointer', fontWeight: 'bold', zIndex: 10 }}
            >
              ✕
            </button>
            {viewFileType === 'application/pdf' || viewImage.toLowerCase().includes('.pdf') ? (
              <iframe src={viewImage} title="Document Preview" style={{ width: '80vw', height: '80vh', border: 'none', borderRadius: '4px', display: 'block' }} />
            ) : (

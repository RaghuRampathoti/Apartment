      ...
      <div className="auth-form-panel">
        <div className="auth-form-box">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Field icon={<UserIcon />} label="Username" placeholder="Choose a username" value={form.username} onChange={(e) => {
            ...
            <Field icon={<PhoneIcon />} label="Contact Number" placeholder="10-digit number" value={form.contactNumber} onChange={(e) => {

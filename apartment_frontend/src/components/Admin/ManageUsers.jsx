          ...
          <div className="p-10">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">User Identity <span className="text-rose-500">*</span></label>
                <input
                  type="text"
                  ...
                  onChange={(e) => {
                    ...
                    setUserData({ ...userData, username: lettersOnly });
                  }}
                />
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Email Endpoint <span className="text-rose-500">*</span></label>
                <input
                  type="email"
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Primary Contact <span className="text-rose-500">*</span></label>
                <input
                  type="tel"
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Access Permissions <span className="text-rose-500">*</span></label>
                <select
...
>
              ...
              {(userData.role ==="ROLE_ADMIN" || userData.role ==="ROLE_SECURITY") && apartments.length> 0 && (
                <div className="space-y-2 md:col-span-2">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Assigned Domain <span className="text-rose-500">*</span></label>
                  <select
                    className="w-full px-5 py-4 rounded-2xl border border-slate-200 bg-slate-50 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all font-bold text-slate-700"
                ...
                <div className="mt-16 px-10 pb-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12 bg-slate-50/50 p-8 rounded-[2rem] border border-slate-100">
                     <div className="space-y-1">
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Identity Type</p>
                     ...
                     <div className="space-y-1">
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Domain Residency</p>
                        <p className="text-sm font-black text-slate-700">{u.managedApartmentName || u.apartmentName ||"EXTERNAL"}</p>
                     </div>
                     {u.flatNumber && (
                        <div className="space-y-1">
                           <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Asset Location</p>
                  ...
                  <div className="mt-auto pt-10 border-t border-slate-100">
                    <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-6">Account Stewardship</h4>
                      ...
                      <div className="bg-rose-50 p-6 rounded-3xl border border-rose-100">
                        {deactivateConfirmId === u.id ? (
                          ...
                          <div className="flex justify-between items-center">
                             <div className="">
                                <p className="text-rose-800 font-black text-sm">Deactivate Security Clearance</p>
                          ...
                          <div className="space-y-6">
                            ...
                            {userRole ==="ROLE_RESIDENT" && (
                              <div className="max-w-md">
                                <label className="text-[10px] font-black text-indigo-400 uppercase tracking-widest mb-3 block">Asset Allocation Required</label>
                                <select
...
>
                            ...
                            <div className="flex gap-4">
                              <button className="px-10 py-3.5 bg-indigo-600 text-white rounded-2xl font-black text-xs uppercase shadow-xl shadow-indigo-600/20" onClick={() => submitReactivate(u)}>
                                {u.status ==="PENDING" ? <><IoCheckmarkOutline className="inline mr-1" /> APPROVE ENTRY</> : <><IoRefreshOutline className="inline mr-1" /> RESTORE CLEARANCE</>}
                              </button>
                          ...
                          <div className="flex justify-between items-center">
                             <div className="">
                                <p className="text-indigo-800 font-black text-sm">Restore Environment Clearance</p>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-20 text-center">
              ...
              <h3 className="text-2xl font-black text-slate-800 mb-2  uppercase tracking-tight">Identity Focus Needed</h3>

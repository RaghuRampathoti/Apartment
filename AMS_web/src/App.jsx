      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'glass-header py-3 shadow-lg' : 'bg-transparent py-5'}`}>
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a href="https://secure-gate-lr.netlify.app/signup" className="bg-primary text-white text-sm font-bold px-6 py-2.5 rounded-lg shadow-lg shadow-primary/20 hover:bg-primary-dark hover:-translate-y-0.5 transition-all active:scale-95">
              Get Started
            </a>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-full left-0 right-0 bg-white shadow-2xl border-t md:hidden animate-fade-in p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              ...
              <a href="https://secure-gate-lr.netlify.app/signup" className="text-center py-3 font-bold text-white bg-primary rounded-xl shadow-lg">Signup</a>
            </div>
          </div>
        )}
      </header>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto space-y-4 pt-10">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center mt-2 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <a
              href="https://secure-gate-lr.netlify.app/signup"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, i) => (
              ...
              >
                ...
                <button className={`w-full py-5 rounded-2xl font-black uppercase tracking-widest text-xs transition-all ${plan.popular ? 'bg-primary text-white shadow-xl shadow-primary/30 hover:bg-primary-dark' : 'bg-white/10 text-white hover:bg-white/20 border border-white/10'}`}>
                  Choose Plan
                </button>
              </div>
            ))}
      ...
      <section className="py-20 bg-slate-50 relative overflow-hidden">
        <div className="max-w-3xl mx-auto text-center px-4 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            <button className="bg-primary text-white font-black uppercase tracking-widest text-sm py-5 px-12 rounded-2xl shadow-2xl shadow-primary/30 hover:scale-105 transition-all">
              Schedule a Demo
            </button>
            <button className="bg-white border-2 border-slate-200 text-slate-800 font-black uppercase tracking-widest text-sm py-5 px-12 rounded-2xl hover:border-primary transition-all">
              Contact Sales
            </button>
          </div>
        </div>
      ...
      <footer className="bg-slate-900 pt-24 pb-12 px-4 md:px-8 text-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="text-slate-400 text-sm font-medium">ops@arahinfotech.com</li>
              <li className="text-slate-400 text-sm font-medium">+91 9898989898</li>
              <li className="text-slate-400 text-sm font-medium">Madhapur beside Raju Gari Biryani, <br />Hyderabad, India</li>
            </ul>
          </div>
        </div>
